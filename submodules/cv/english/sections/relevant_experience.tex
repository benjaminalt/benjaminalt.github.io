...
\begin{itemize}
  \item Led the development of a software ecosystem for open-source cognitive robotics
  \item Co-led research on hybrid AI for robot perception and manipulation
  \item Translated research prototypes into deployable systems in collaboration with spin-off and industrial partners
  \item Acquired third-party funding for research and technology transfer
\end{itemize}
