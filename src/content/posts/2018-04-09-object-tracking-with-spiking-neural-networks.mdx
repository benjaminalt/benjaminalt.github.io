...
import img_hbp_screenshot_spike_train from '../../assets/img/hbp/screenshot_spike_train.png';
import img_hbp_control_loop from '../../assets/img/hbp/control_loop.png';
import img_hbp_icub_perception from '../../assets/img/hbp/icub_perception.png';
import img_hbp_retina_regions from '../../assets/img/hbp/retina_regions.png';
...
<Figure src={img_hbp_screenshot_spike_train} width="bleed" loading="eager" caption="A spike train of a population of neurons, visualized in the Neurorobotics platform." />
...
<Figure src={img_hbp_control_loop} width="bleed" loading="eager" caption="Object tracking realized with closed-loop control." />
...
<Figure src={img_hbp_icub_perception} width="bleed" loading="eager" caption="The thimblerigger experiment in the Neurorobotics platform." />
...
<Figure src={img_hbp_retina_regions} width="bleed" loading="eager" caption="The PopulationViews dividing the retina into four regions." />
