...
{% include image.html url="/assets/images/spi/overview.png" description="SPI decomposes robot program parameter inference into unsupervised learning of a composable, differentiable model of robot skills (top) followed by gradient-based inversion of the learned model (bottom)." width_percent="75" %}
{:overview}
...
{% include image.html url="/assets/images/spi/shadow_program.png" description="A Shadow Program composed of two Shadow Skills. Just as Shadow Skills are models for individual robot skills, Shadow Programs model complex robot programs (left to right) and allow for the joint optimization of program parameters via gradient descent (right to left)." width_percent="75"%}
...
{% include video.html url="https://www.youtube.com/embed/GwQdFN5lmLk" %}
