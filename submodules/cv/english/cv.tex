...
\begin{quote}
\begin{center}
Researcher in robot manipulation and perception, focusing on learning-based and neurosymbolic methods for visuotactile interaction, autonomous task planning and execution, and 3D scene understanding. Proven record of translating core AI research on optimization and neural representations into deployed robotic systems.
\end{center}
\end{quote}
...
\input{sections/patents_tech_transfer.tex}
