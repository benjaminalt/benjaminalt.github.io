...
\emph{Co-Founder and Chief Scientific Officer}, AICOR Solutions GmbH % Current or most recent employment position
...
\years{2020-2025}\textsc{Ph.D.} in Computer Science - \textit{magna cum laude} \\
...
Advisor: Prof. Dr. Michael Beetz\\
Committee: Prof. Dr. Aude Billard, Prof. Dr. Tania Schultz, Prof. Dr. Nico Hochgeschwender 

\medskip

\years{2017-2019}\textsc{M.Sc.} Computer Science\\ - \textit{with distinction}
...
\years{2012-2015}\textsc{B.A.} Political Science\\ - \textit{summa cum laude} 
...
\years{2025-}Co-Founder and Chief Scientific Officer, AICOR Solutions GmbH, Bremen, Germany

\medskip

\years{2025-2026}Technical Director, AICOR Institute for Artificial Intelligence, University of Bremen, Germany

\medskip

\years{2024-2025}Senior Team Lead Research, ArtiMinds Robotics, Karlsruhe, Germany
...
% Conference proceedings (excluding workshop papers)
\newcommand{\firstconfentries}[1]{%
  \defbibcheck{conf#1}{\iffieldequalstr{year}{#1}{}{\skipentry}\ifkeyword{workshop}{\skipentry}{}}%
  \years{#1}\vspace{0pt}\printbibliography[type=inproceedings,heading=none,check=conf#1]
}

\newcommand{\confentries}[1]{%
  \defbibcheck{conf#1}{\iffieldequalstr{year}{#1}{}{\skipentry}\ifkeyword{workshop}{\skipentry}{}}%
  \years{#1}\vspace{-10pt}\printbibliography[type=inproceedings,heading=none,check=conf#1]
}

% Workshop papers
\newcommand{\firstworkshopentries}[1]{%
  \defbibcheck{ws#1}{\iffieldequalstr{year}{#1}{}{\skipentry}\ifkeyword{workshop}{}{\skipentry}}%
  \years{#1}\vspace{0pt}\printbibliography[type=inproceedings,heading=none,check=ws#1]
}

\newcommand{\workshopentries}[1]{%
  \defbibcheck{ws#1}{\iffieldequalstr{year}{#1}{}{\skipentry}\ifkeyword{workshop}{}{\skipentry}}%
  \years{#1}\vspace{-10pt}\printbibliography[type=inproceedings,heading=none,check=ws#1]
}
...
\firstpubentries{2025}{article}
\pubentries{2024}{article}

\subsection*{Conference Proceedings}

\firstconfentries{2025}
\confentries{2024}
\confentries{2023}
\confentries{2022}
\confentries{2021}
...
\firstworkshopentries{2025}
\workshopentries{2021}

\subsection*{Manuscripts in Submission}
\firstpubentries{2026}{misc}
\pubentries{2025}{misc}
...
\section*{Grants}
\years{2026-2028}MATENA innovate! Transfer Project\\
Digital Twin-based Automated Fiber Placement for Rivet-Free Manufacturing of Aerospace Components (TWINSPACE)\\
Co-PI\\
\years{2025-2026}German Academic Exchange Service (DAAD) grant\\
Digital Twins for Household Autonomous Robots\\
PI\\
...
``Semantic Digital Twins and Virtual Robot Labs for Reproducible, Accessible Scientific Discovery''\\
3rd Workshop on Accelerating Discovery in Natural Science Laboratories with AI and Robotics\\
International Conference on Robotics and Automation (ICRA 2026), Vienna, 01.06.2026

\medskip

\years{2025}

``Hybrid AI for Safe Embodied Intelligence''\\
Robotics and Biology (RBO) Lab / Science of Intelligence Excellence Cluster\\
Technische Universität Berlin, Berlin, 28.11.2025
...
``Bridging the AI Application Gap in Industrial Robotics with Ontologies and Standards''\\
3rd Workshop on Ontologies and Standards for Robotics and Automation (WOSRA)\\
IEEE International Conference on Robotics and Automation (ICRA), Yokohama, 13.05.2024
...
``Semantic Digital Twins and Virtual Robot Labs for Reproducible, Accessible Scientific Discovery''\\
3rd Workshop on Accelerating Discovery in Natural Science Laboratories with AI and Robotics, 
International Conference on Robotics and Automation (ICRA), June 1, 2026

\medskip

\years{2025}
``Semantic Digital Twins for Robust and Flexible Robot Behavior'', 2nd Workshop on Semantic Reasoning and Goal Understanding in Robotics (SemRob), Robotics Science and Systems Conference (RSS), June 21, 2025 
...
``The AICOR Virtual Research Building: Collaborative Robotics in the Cloud'', ROSCon UK, September 17
...
University of California, Berkeley, 23.07.2025
...
\years{2026}Co-Organizer, Hands-On Workshop ``AI-Based Robotics in the Cloud with the Virtual Research Building (VRB)'', IEEE/ASME International Conference on Advanced Intelligent Mechatronics (AIM), Genova, Italy
...
Conferences: IEEE ICRA, IEEE/RSJ IROS, IEEE CASE, KR, IJCAI, IEEE/ASME AIM

Journals: IEEE Robotics and Automation Lettes (RA-L), KI - Künstliche Intelligenz
