...
{% include image.html url="/assets/images/hbp/screenshot_spike_train.png" description="A spike train of a population of neurons, visualized in the Neurorobotics platform." %}
...
{% include image.html url="/assets/images/hbp/control_loop.png" description="Object tracking realized with closed-loop control." %}
...
{% include image.html url="/assets/images/hbp/icub_perception.png" description="The thimblerigger experiment in the Neurorobotics platform." %}
...
{% include image.html url="/assets/images/hbp/retina_regions.png" description="The PopulationViews dividing the retina into four regions." %}
