...
import img_spi_overview from '../../assets/img/spi/overview.png';
import img_spi_shadow_skill from '../../assets/img/spi/shadow_skill.png';
import img_spi_shadow_program from '../../assets/img/spi/shadow_program.png';

This is the companion blog post to our 2021 ICRA paper. You can find more on the paper (including a full-text version) [here](https://arxiv.org/abs/2103.14452).
...
<Figure src={img_spi_overview} width="bleed" loading="eager" caption="SPI decomposes robot program parameter inference into unsupervised learning of a composable, differentiable model of robot skills (top) followed by gradient-based inversion of the learned model (bottom)." />
...
<Figure src={img_spi_shadow_skill} width="bleed" loading="eager" caption="A Shadow Skill as part of a larger Shadow Program." />
...
<Figure src={img_spi_shadow_program} width="bleed" loading="eager" caption="A Shadow Program composed of two Shadow Skills. Just as Shadow Skills are models for individual robot skills, Shadow Programs model complex robot programs (left to right) and allow for the joint optimization of program parameters via gradient descent (right to left)." />
