...
import img_wire_harness_case25_setup from '../../assets/img/wire-harness-case25/setup.png';
import img_wire_harness_case25_framework from '../../assets/img/wire-harness-case25/framework.png';
...
You can find the paper on [ArXiv](https://arxiv.org/abs/2503.09409) and as a PDF [here ↗](/assets/pdf/wire_harness_CASE25.pdf).
...
<Figure src={img_wire_harness_case25_setup} width="narrow" loading="eager" />
...
<Figure src={img_wire_harness_case25_framework} width="bleed" loading="eager">
